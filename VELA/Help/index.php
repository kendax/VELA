     ...
     <nav class="nav1">
            <ul>
              ...
              <li class="accessories" style="transform:translateY(-70px);"><a>
                      ...
                      <div class="login">
                          <button type="button" class="buttonlogin" style="transform:translateX(30px);"><a  href="../logout.php" style="color:white;">Logout</a></button>
                      </div>
              </a></li>

              <li class="accessories1" style="transform:translateX(12px); transform:translateY(-70px); margin-left:0px;"><a>
